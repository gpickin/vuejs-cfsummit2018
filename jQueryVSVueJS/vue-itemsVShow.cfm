...
<cfoutput>
    ...
    <h1>List Loader for Pesticides - VueJS - 3 - V-Show on Items</h1>
    ...
    <div>
        ...
        Or
        <input type="checkbox" name="searchCheck" id="searchCheck" value="1" v-model="showSelectedOnly" @click="toggleSelect"> Checked
    </div>
    ...
    <table cellspacing="0" cellpadding="3">
        ...
        <tr v-for="item in items" v-show="show( item )">
            <td>
